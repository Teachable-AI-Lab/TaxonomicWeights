#!/usr/bin/env python3
"""Analysis script for the TopK Multi-Taxon Autoencoder on CelebA-HQ.
...
# Reuse analysis functions from the multi-taxon script
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Analyze TopK MultiTaxon AE on CelebA-HQ")
...
def main() -> None:
    ...
    print("=" * 80)
    print("TopK MultiTaxon Autoencoder — Analysis")
    print("=" * 80)
