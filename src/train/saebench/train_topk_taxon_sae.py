#!/usr/bin/env python3
"""Train TopKTaxonSAE on LLM residual-stream activations using SAEBench conventions.
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Train TopKTaxonSAE (SAEBench-compatible)")
    ...
    parser.add_argument("--output-dir",           type=str,   default=o.get("output_dir",
                                                              "./outputs/saebench/topk_taxon_sae"))
...
def main() -> None:
    ...
    suffix = f"_L{args.n_taxonomy_layers}_t{temp_str}{hard_str}"
    ...
    save_training_curves(history, output_dir, "TopKTaxonSAE")
