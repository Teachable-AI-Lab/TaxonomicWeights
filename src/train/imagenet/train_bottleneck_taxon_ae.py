#!/usr/bin/env python3
"""Train BottleneckTaxonAutoencoder on ImageNet-1k.
...
def save_training_curves(history, output_dir) -> None:
    ...
    plt.suptitle("Bottleneck Taxon AE — ImageNet")
    plt.tight_layout()
...
def parse_args():
    ...
    p.add_argument("--output-dir", type=str,
                   default=o.get("output_dir", "./outputs/bottleneck_taxon_ae_imagenet"))
...
def main() -> None:
    ...
    print(f"Bottleneck Taxon AE (ImageNet): device={device} n_params={n_params:,} L={L} "
          f"latent_ch={model.encoder.final_channels} "
