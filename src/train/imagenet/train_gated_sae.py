#!/usr/bin/env python3
"""Train GatedSparseConvAutoencoder on ImageNet-1k.

Mirrors src/train/train_sae_imagenet.py.  Sparsity is induced via
...
def save_training_curves(history: dict, output_dir: Path) -> None:
    ...
    plt.suptitle("Gated SAE ImageNet-1k training curves", fontsize=13, fontweight="bold")
    plt.tight_layout()
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Train Gated SAE on ImageNet-1k")
    parser.add_argument("--config",          type=str,   default="")
    parser.add_argument("--data-root",       type=str,   default=d.get("data_root",       "./data/imagenet"))
    parser.add_argument("--output-dir",      type=str,   default=o.get("output_dir",      "./outputs/sae_gated_imagenet_r18"))
...
def main() -> None:
    ...
    print(
        "Training setup (Gated SAE ImageNet-1k):\n"
