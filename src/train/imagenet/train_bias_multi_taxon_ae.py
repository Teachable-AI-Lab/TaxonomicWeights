#!/usr/bin/env python3
"""Train BiasMultiTaxonAutoencoder on ImageNet-1k with ResNet-18 stage layout.
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Train Bias Multi-Taxon AE on ImageNet-1k")
    parser.add_argument("--config", type=str, default="")
    # data
    parser.add_argument("--data-root", type=str, default=d.get("data_root", "./data/imagenet"))
    parser.add_argument("--output-dir", type=str,
                        default=o.get("output_dir", "./outputs/bias_multi_taxon_ae_imagenet_r18"))
