#!/usr/bin/env python3
"""Train TopKMultiTaxonAutoencoder on CIFAR-10 with ResNet-18 stage layout.
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Train TopK Multi-Taxon AE on CIFAR-10")
    parser.add_argument("--config", type=str, default="")
    # data
    parser.add_argument("--data-root", type=str, default=d.get("data_root", "./data"))
    parser.add_argument("--output-dir", type=str,
                        default=o.get("output_dir", "./outputs/topk_multi_taxon_ae_cifar10_r18"))
