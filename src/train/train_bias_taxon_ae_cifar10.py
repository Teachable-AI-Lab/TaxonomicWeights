#!/usr/bin/env python3
"""Train BiasTaxonAutoencoder on CIFAR-10 with ResNet-18 stage layout.
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Train Bias Taxon AE on CIFAR-10")
    parser.add_argument("--config", type=str, default="")
    # data
    parser.add_argument("--data-root", type=str, default=d.get("data_root", "./data"))
    parser.add_argument("--output-dir", type=str,
                        default=o.get("output_dir", "./outputs/bias_taxon_ae_cifar10_r18"))
...
def main() -> None:
    ...
    print(
        ...
        f"  k={args.k} bias_update_rate={args.bias_update_rate}\n"
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        ...
        with torch.no_grad():
            for s_idx, stage in enumerate(model.encoder.taxon_stages):
                bias_vals = stage._leaf_bias.cpu().tolist()
