...
MAIN_CONFIG_RELPATHS: List[str] = [
    ...
    "configs/celeba_hq/main/bottleneck_topk_taxon/bottleneck_topk_taxon_ae_celeba_hq_r18_v1_main_L8_stable.json",
    ...
    "configs/celeba_hq/main/bottleneck_jumprelu_taxon/bottleneck_jumprelu_taxon_ae_celeba_hq_r18_v1_main_L8_stable.json",
