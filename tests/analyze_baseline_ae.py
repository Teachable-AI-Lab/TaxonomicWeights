...
Usage:
    # CelebA-HQ
    python tests/analyze_baseline_ae.py --config configs/baseline_ae_celeba_hq.json

    # CIFAR-10
    python tests/analyze_baseline_ae.py --config configs/baseline_ae_cifar10.json

    # Custom checkpoint
    python tests/analyze_baseline_ae.py \\
